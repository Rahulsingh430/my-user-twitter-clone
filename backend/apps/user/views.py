...
from .mixins import CustomLoginMixinRequired
...
class UserCheckLogin(CustomLoginMixinRequired, generics.RetrieveAPIView):
...
class UserList(CustomLoginMixinRequired, generics.ListAPIView):
